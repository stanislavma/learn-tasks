package sprint_7.topic_1_stream_api.streamapi.lambda;
...
public class BookEditor {
    ...
    public static void main(String[] args) {
        ...
        List<String> content = Arrays.asList("Приключения Java-программиста", "История началась рано утром, ", "когда программист вышел из дома, ", "решив выпить утренний кофе.");
