package sprint_7.topic_1_stream_api.streamapi.circuiting;
...
public class UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        List<Student> graduatedStudents = students.stream()
                ...
                .peek(student -> {
                    String groupName = groupNames.get(student.entranceYear);
                    if (groupName != null) {
                        student.groupName = groupName;
                    }
                })
                .peek(student -> graduatesClub.add(String.valueOf(student.email)))
