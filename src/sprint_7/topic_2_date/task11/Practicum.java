package sprint_7.topic_2_date.task11;
...
//            String departureFmt = departure.format(TIME_FORMATTER);
            ...
            Duration flightDuration = Duration.ofMinutes((flightDurationHours * 60L) + flightDurationMinutes);
