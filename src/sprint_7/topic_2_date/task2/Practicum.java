package sprint_7.topic_2_date.task2;
...
public class Practicum {
    ...
    private static int dayOfYearFromInstant(Instant startOfYear, Instant time) {
        long fromStartOfYear = startOfYear.toEpochMilli();

        long days= TimeUnit.MILLISECONDS.toDays(time.toEpochMilli() - fromStartOfYear);
